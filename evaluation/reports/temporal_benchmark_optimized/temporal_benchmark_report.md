...
|---|---|---|---|
| **First-Decision Latency** | **0.880 s** | Window duration (~4.04s) + 1 forward pass | ✅ Optimal |
| **Per-Window Inference Latency (Mean)** | **850.69 ms** | $< 1000$ ms (hop size) | ✅ Real-Time Capable |
| **Per-Window Inference Latency (p95)** | **975.54 ms** | $< 1000$ ms | ✅ Real-Time Capable |
| **Per-Window Inference Latency (p99)** | **998.44 ms** | $< 1200$ ms | ✅ Stable |
| **Real-Time Factor (RTF)** | **0.6382** | $< 1.0$ (Faster than real-time) | ✅ Faster than Real-Time |
| **Real-Time Speedup** | **1.57x** | $> 1.0\times$ | ✅ High Throughput |
| **Processing Throughput** | **1.18 windows/s** | Overlapping stride processing | ✅ High Throughput |
| **Total Processed Audio** | **12.0 seconds** | Continuous streaming audio | ✅ Verified |
| **Peak Process Memory (RSS)** | **1814.9 MB** | $< 2.0$ GB | ✅ Memory Efficient |
| **Memory Delta (Engine + Model)** | **+1510.3 MB** | Controlled footprint | ✅ Minimal Overhead |
...
|---|---|---|---|---|---|---|---|---|
| `0` | `0.00s – 4.04s` | `-0.9778` | `0.0102` | `99.0` | **99.0** | `BONAFIDE` | `0.98` | `879.2 ms` |
| `1` | `1.00s – 5.04s` | `-1.2109` | `0.0077` | `99.2` | **99.1** | `SPOOF` | `0.98` | `803.4 ms` |
| `2` | `2.00s – 6.04s` | `-1.3068` | `0.0068` | `99.3` | **99.2** | `SPOOF` | `0.99` | `783.7 ms` |
| `3` | `3.00s – 7.04s` | `-0.7507` | `0.0134` | `98.7` | **99.0** | `SPOOF` | `0.97` | `787.0 ms` |
| `4` | `4.00s – 8.04s` | `-0.8164` | `0.0123` | `98.8` | **98.9** | `SPOOF` | `0.98` | `1004.2 ms` |
| `5` | `5.00s – 9.04s` | `-1.2575` | `0.0072` | `99.3` | **99.0** | `SPOOF` | `0.99` | `810.6 ms` |
| `6` | `6.00s – 10.04s` | `-0.6559` | `0.0150` | `98.5` | **98.8** | `SPOOF` | `0.97` | `827.1 ms` |
| `7` | `7.00s – 11.04s` | `-1.0444` | `0.0094` | `99.1` | **98.9** | `SPOOF` | `0.98` | `828.4 ms` |
| `8` (flush) | `8.00s – 12.00s` | `-1.2889` | `0.0070` | `99.3` | **99.1** | `SPOOF` | `0.99` | `932.6 ms` |
