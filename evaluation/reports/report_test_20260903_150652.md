...
- **Bona Fide (Genuine) Samples:** 2 (50.0%)
- **Spoof (Deepfake) Samples:** 2 (50.0%)
- **Unique Speakers:** 1
...
|---|---|---|
| **Actual Spoof (0)** | TN = **2** | FP = **0** |
| **Actual Bona Fide (1)** | FN = **0** | TP = **2** |

## 4. Benchmark Throughput & Latency
- **Total Inference Time:** 3.52 seconds
- **Average Latency:** 879.21 ms / sample
- **Inference Throughput:** 1.14 utterances / sec
